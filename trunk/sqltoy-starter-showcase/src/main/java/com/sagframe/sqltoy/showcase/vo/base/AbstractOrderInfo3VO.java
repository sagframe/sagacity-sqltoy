 ...
 */
@Entity(tableName="TRADE_ORDER_INFO_3")
public abstract class AbstractOrderInfo3VO implements Serializable,
	java.lang.Cloneable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4659681221908611863L;
	 ...
	 * 状态
	 */
	@Column(name="STATUS",length=0L,defaultValue="1",type=java.sql.Types.VARCHAR,nullable=false)
	protected String status;
	


	/** default constructor */
	public AbstractOrderInfo3VO() {
	}
	
	/** pk constructor */
	public AbstractOrderInfo3VO(String orderId)
	{
	...
	/** full constructor */
	public AbstractOrderInfo3VO(String orderId,String orderType,String buyer,String saler,LocalDate orderDate,Float totalAmt,Float quantity,Float price,String status)
	{
		this.orderId=orderId;
