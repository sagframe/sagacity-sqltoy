...
public class SqlToyContextProperties implements Serializable {
	 ...
	 * (update 2026-9-5:Object类型无法绑定yml数组/列表写法,会静默为null导致配置失效,改为List;
	 * yml的数组写法与逗号分隔字符串写法均自动转换,兼容原逗号串配置形式)
	 */
	 ...
	 * (setter参数为List,Binder以setter参数类型为绑定目标;yml数组与逗号分隔字符串两种写法均自动转换)
	 *
