...
public class CacheMatchFilter implements Serializable {
	...
	/**
	 * 设置缓存类别，一般针对数据字典类型的缓存才需要额外指定子分类
	 * 
	 * @param cacheType
	 * @return
	 */
	...
	/**
	 * 设置最大匹配量，比如用于sql中 in (keys) 有1000限制
	 * 
	 * @param matchSize
	 * @return
	 */
	...
	/**
	 * 设置匹配表达式跟缓存中哪几列数据进行匹配，默认为1,比如员工缓存，第0列为工号，第1列为员工名称，用名称匹配到工号
	 * 
	 * @param matchIndexs
	 * @return
	 */
