...
public class VastbaseDialect implements Dialect {

    /**
     * 定义日志
     */
    protected final Logger logger = LoggerFactory.getLogger(VastbaseDialect.class);
                ...
                new GenerateSqlHandler() {
                    ...
                    public String generateSql(EntityMeta entityMeta, String[] forceUpdateField) {
                        ...
                        return DialectExtUtils.generateInsertSql(sqlToyContext.getUnifyFieldsHandler(), dbType,
                                ...
                                VastbaseDialectUtils.isAssignPKValue(pkStrategy), null);
                    }
                }, new GenerateSavePKStrategy() {
                    @Override
                    public SavePKStrategy generate(EntityMeta entityMeta) {
                        return new SavePKStrategy(entityMeta.getIdStrategy(),
                                VastbaseDialectUtils.isAssignPKValue(entityMeta.getIdStrategy()));
                    }
                }, conn, dbType);
    }
    ...
    public List<ColumnMeta> getTableColumns(String catalog, String schema, String tableName, Connection conn,
        ...
        return VastbaseDialectUtils.getTableColumns(catalog, schema, tableName, conn, dbType, dialect);
    }

    @Override
    public List<TableMeta> getTables(String catalog, String schema, String tableName, Connection conn, Integer dbType,
                                     String dialect) throws Exception {
        return VastbaseDialectUtils.getTables(catalog, schema, tableName, conn, dbType, dialect);
    }
