 ...
 * @modify Date:2022-11-19
 *         setNull和setValue增加了一个dbType参数，便于同样代码适用多个数据库，提供不同数据库逻辑判断
 */
public abstract class TypeHandler {
	/**
	 * 当数据为null时,pst.setNull(index,java.sql.Types.xxxx)
	...
	/**
	 * 将例如json等resultSet中的结果转为java对象，映射到VO属性上
	 ...
	 * 
	 * 针对ResultSet.get(index) 返回的数据库特定类型(如:Struct、数组等)，转化成java常见的类型
