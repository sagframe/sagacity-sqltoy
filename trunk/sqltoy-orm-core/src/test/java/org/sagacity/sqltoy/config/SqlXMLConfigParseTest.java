...
public class SqlXMLConfigParseTest {
	...
	public void testChinaParamName() throws Exception {
		// String sql = "select * from table where 1=1 #[and id=:单据_编号_id] and name like
		// @value(:name) #[and status=:status]";
		String sql = "select * from table where 1=1 #[and id=:单据_编号_id] and name like ${name} #[and status=:status]";
