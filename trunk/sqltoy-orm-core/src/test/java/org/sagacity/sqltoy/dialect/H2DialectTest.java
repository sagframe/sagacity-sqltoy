...
public class H2DialectTest {
	...
	public void testValidateQuery() {
		try {
			...
			Connection conn = DBUtilsTest.getConnection(DBUtilsTest.DRIVER_H2,
					"jdbc:h2:file:/Users/hujun/Documents/temp/jztools/db/jztools", "root", "root");
	...
	public void testMerge() {
		try {
			String nvlsql = "MERGE INTO TABLE1 AS T USING TABLE12 AS S" + "    ON T.ID = S.ID"
					+ "    WHEN MATCHED AND T.COL2 <> 'FINAL' THEN" + "        UPDATE SET T.COL1 = S.COL1"
					+ "    WHEN MATCHED AND T.COL2 = 'FINAL' THEN" + "        DELETE" + "    WHEN NOT MATCHED THEN"
