...
public class SqlToyDaoSignatureTest {
    ...
    public void testMethodNameConventions() {
        ...
        for (Method method : methods) {
            ...
            // 检查是否符合常见的命名模式
            boolean isStandard = methodName.startsWith("findOne") ||
                               methodName.startsWith("findAll") ||
                               methodName.startsWith("findList") ||
                               methodName.startsWith("findTop") ||
                               methodName.startsWith("findRandom") ||
                               methodName.startsWith("findPage") ||
                               methodName.startsWith("findStream") ||
                               ...
                               methodName.startsWith("translate") ||
                               methodName.startsWith("cache") ||
                               methodName.startsWith("generate") ||
                               methodName.startsWith("wrap") ||
                               methodName.startsWith("truncate") ||
                               methodName.startsWith("flush") ||
                               methodName.startsWith("exist") ||
                               methodName.equals("count") ||
                               methodName.equals("elastic") ||
                               methodName.equals("mongo") ||
                               ...
                               methodName.equals("unique") ||
                               methodName.equals("treeTable") ||
                               methodName.equals("execute") ||
                               methodName.equals("batch") ||
                               methodName.equals("tableApi");
