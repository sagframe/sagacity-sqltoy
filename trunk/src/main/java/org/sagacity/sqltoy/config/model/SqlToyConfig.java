...
public class SqlToyConfig implements Serializable, java.lang.Cloneable {
	 ...
	 * 翻译器
	 */
	private HashMap<String, TranslateModel> translateMap = null;
	 ...
	 */
	public HashMap<String, TranslateModel> getTranslateMap() {
		return translateMap;
	}
	 ...
	 */
	public void setTranslateMap(HashMap<String, TranslateModel> translateMap) {
	...
	public void setPageAliveMax(int pageAliveMax) {
		// 最大不超过10000
		if (pageAliveMax > 10000)
			this.pageAliveMax = 1000;
		// 最小20
