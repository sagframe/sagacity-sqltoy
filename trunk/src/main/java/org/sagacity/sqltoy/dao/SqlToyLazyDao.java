...
public interface SqlToyLazyDao {
	...
	/**
	 * @todo 通过Criteria标准对象查询机制构造查询语句
	 * @param criteria
	 * @return
	 * @throws Exception
	 */
	@Deprecated
	public List findByCriteria(final Criteria criteria) throws Exception;
	 ...
	 */
	@Deprecated
	public PaginationModel findPageByCriteria(final PaginationModel pageModel, final Criteria criteria)
			throws Exception;
