...
import org.sagacity.sqltoy.showcase.vo.DictDetailVO;
...
public abstract class AbstractDictTypeVO implements Serializable,
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1620139595576220819L;
	 ...
	 * 主键关联子表信息
	 */
	@OneToMany(fields={"dictType"},mappedTable="sqltoy_dict_detail",mappedColumns={"DICT_TYPE"},mappedFields={"dictType"},load="STATUS=1",update="delete")
