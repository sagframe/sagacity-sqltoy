 ...
 */
@Entity(tableName="TRADE_ORDER_INFO_1")
public abstract class AbstractOrderInfo1VO implements Serializable,
	java.lang.Cloneable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3785344705269748734L;
	...
	/** default constructor */
	public AbstractOrderInfo1VO() {
	}
	
	/** pk constructor */
	public AbstractOrderInfo1VO(String orderId)
	{
	...
	/** full constructor */
	public AbstractOrderInfo1VO(String orderId,String orderType,String buyer,String saler,LocalDate orderDate,Float totalAmt,Float quantity,Float price,String status)
	{
		this.orderId=orderId;
