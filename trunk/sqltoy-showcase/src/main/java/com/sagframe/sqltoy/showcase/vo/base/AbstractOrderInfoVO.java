 ...
 */
@Entity(tableName="TRADE_ORDER_INFO")
public abstract class AbstractOrderInfoVO implements Serializable,
	...
	/** full constructor */
	public AbstractOrderInfoVO(String orderId,String orderType,String buyer,String saler,LocalDate orderDate,Float totalAmt,Float quantity,Float price,String status)
	{
		this.orderId=orderId;
