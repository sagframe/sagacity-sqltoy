 ...
 * @version 1.0.0
 * Table: sys_sharding_real,Remark:分片测试实时表   
 */
@Entity(tableName="sys_sharding_real",pk_constraint="PRIMARY")
public abstract class AbstractShardingRealVO implements Serializable,
	java.lang.Cloneable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2017078513392433981L;
	...
	/** default constructor */
	public AbstractShardingRealVO() {
	}
	
	/** pk constructor */
	public AbstractShardingRealVO(BigDecimal id)
	{
		this.id=id;
	}

	/** minimal constructor */
	public AbstractShardingRealVO(BigDecimal id,String staffId,Date createTime)
	{
		this.id=id;
	...
	/** full constructor */
	public AbstractShardingRealVO(BigDecimal id,String staffId,String postType,Date createTime,String comments)
	{
		this.id=id;
		this.staffId=staffId;
