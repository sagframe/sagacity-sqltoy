...
import org.sagacity.sqltoy.cache.impl.PageOptimizeCacheImpl;
...
public class SqlToyContext implements ApplicationContextAware {
	 ...
	 * 默认缓存翻译的数据库
	 */
	private String translateDataSource = "dataSource";
	...
	/**
	 * 分页优化缓存(提供一个接口实现,以供在分布式场景下应用redis等缓存框架来实现,默认则通过HashMap本地实现)
	 */
	private PageOptimizeCache pageOptimizeCache;
	...
	public void initialize() throws Exception {
		 ...
		 * 初始化翻译器
		 */
		translateManager.setTranslateCacheManagers(translateCacheManagers);
		translateManager.setDefaultDataSource(getTranslateDataSource());
		translateManager.initialize();

		// 启用本地HashMap默认实现模式
		if (null == pageOptimizeCache)
			pageOptimizeCache = new PageOptimizeCacheImpl();
		// 启动内部处理
		pageOptimizeCache.start();
	}
	...
	public void setCacheManager(Object cacheManager) {
		translateManager.setCacheManager(cacheManager);
	}
	...
	public void setTranslateCacheManager(TranslateCacheManager translateCacheManager) {
		translateManager.setTranslateCacheManager(translateCacheManager);
	}
	...
	/**
	 * @param pageOptimizeCache
	 *            the pageOptimizeCache to set
	 */
	public void setPageOptimizeCache(PageOptimizeCache pageOptimizeCache) {
		this.pageOptimizeCache = pageOptimizeCache;
	}

	/**
	 * @return the pageOptimizeCache
	 */
	public PageOptimizeCache getPageOptimizeCache() {
		return pageOptimizeCache;
	}

	/**
	 * @return the translateDataSource
	 */
	public String getTranslateDataSource() {
		return translateDataSource;
	}

	/**
	 * @param translateDataSource
	 *            the translateDataSource to set
	 */
	public void setTranslateDataSource(String translateDataSource) {
		this.translateDataSource = translateDataSource;
	}
