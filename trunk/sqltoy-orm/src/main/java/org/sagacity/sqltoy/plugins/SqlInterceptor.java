 ...
 * @description 提供sql拦截器，为一些特殊场景提供自行扩展能力
 * @author zhongxuchen
...
public interface SqlInterceptor {
	 ...
	 * @return
	 */
	public default SqlToyResult decorate(SqlToyContext sqlToyContext,SqlToyConfig sqlToyConfig, OperateType operateType, SqlToyResult sqlToyResult,
			Integer dbType) {
		/**
