...
# 关于可靠性和问题反馈
* sqltoy 其实一路经历金融类项目发展起来的,包含农行、建行、浦发、农信以及拉卡拉支付集团等，从几十万数据规模到几十亿数据规模一步步发展起来,sqltoy这么多独特的特性产生显然是经历了无数项目锤炼而来的!
* 通过开源sqltoy已被更加广泛的场景所验证，坚信4.13.13.1版本之后发现bug是极难的!
