...
# 使用sqltoy的顾虑解答
## sqltoy 是否会不维护? 
* 不用担心这个问题,sqltoy已经相当成熟,出现bug的概率已经很低，已经度过了高强度投入阶段，因此不会放弃sqltoy的维护。
* 我们公司自身项目全部基于sqltoy，不维护时不现实的!
* 已经有上百个公司和项目都在使用sqltoy，不维护岂不是害了这些企业!

## sqltoy的未来发展?
* sqltoy 将启动4.13 版本,进一步优化代码和性能和完善文档。
* 考虑将个人星云报表的部分功能作为一个插件，帮助大家提供更强大的数据服务。
