...
* 2018年~2020年3月:在ERP、CRM、电商等项目上得到了充分验证，尤其是ERP极端复杂的业务逻辑和复杂查询，再次将sqltoy的质量大幅提升!
* 2020年4月至今:全面面向互联网进行开源得到了积极反馈，在各种不同数据库和不同场景下的问题快速得以暴露和处理，sqltoy在一步步的走向成熟！

# 最新发版公告 4.12.12 发版日期:2020-06-17
* 优化debug模式下sql输出，将条件参数带入sql便于调试
* 完善schema的备注说明,便于开发工具中自动提示更完整的信息
* 增强filters 中的eq和neq 逻辑，支持条件参数是数组的场景
