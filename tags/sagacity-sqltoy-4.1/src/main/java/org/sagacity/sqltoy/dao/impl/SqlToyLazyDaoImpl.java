...
public class SqlToyLazyDaoImpl extends BaseDaoSupport implements SqlToyLazyDao {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.sagacity.sqltoy.dao.SqlToyLazyDao#findByCriteria(org.sagacity.sqltoy
	 * .criteria.Criteria)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.sagacity.sqltoy.dao.SqlToyLazyDao#findPageByCriteria(org.sagacity
	 * .core.database.model.PaginationModel, org.sagacity.sqltoy.criteria.Criteria)
	 */
	@Override
	public PaginationModel findPageByCriteria(PaginationModel pageModel, Criteria criteria) throws Exception {
		return super.findPageByCriteria(pageModel, criteria);
	}
