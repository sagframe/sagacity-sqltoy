...
public class SqlXMLConfigParse {
	 ...
	 * @return
	 */
	public static HashMap<String, TranslateModel> parseTranslate(List<Element> translates) {
		if (translates != null && !translates.isEmpty()) {
			// 翻译器
			HashMap<String, TranslateModel> translateMap = new HashMap<String, TranslateModel>();
			String cacheType;
			String cacheName;
			String[] columns;
			Integer[] cacheIndexs;
